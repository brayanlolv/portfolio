    ...
    <div className="flex justify-center md:h-fit items-center mx-auto">
        ...
        <p className="indent-8">
          ...
          <p className="indent-8">Hoje em dia me aventuro no mundo do desenvolvimento de softwares, especialmente na area web,
            ...
            Sou muito aberto a aprendizados e não tenho medo de conhecer novas tecnologias,
          ...
          <p className="indent-8">
            hoje em dia resido na regiao da vila rosalia Guarulhos, porem tambem tenho disponibilidade para atuar em São Paulo capital como um todo,
            inclusive estudo na Vila Maria, tenho um inglês intermediario, que embora seja um ponto que estou 
            buscando melhorar, no contexto técnico de codigo e documentação não me deixa na mão.
          </p>
          {/* <h1>Contatos</h1> */}
